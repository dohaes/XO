//import clientrunner.NetworkGame;
import java.util.*;
import javax.swing.*;
	...
	{	//Game game = new Game();
		...
		while (true)
		{
			...
			// notify player 1 that the game is started
                            ...
                            NetworkGame game = new NetworkGame (1);
                            String from= s.substring(s.indexOf(":"),s.indexOf("#"));
                            String to= s.substring(s.indexOf("#"),s.length());
			...
			// notify player 2
                        ...
                        NetworkGame game = new NetworkGame (2);
                            player2=new Human(2);
                            //player2.play(board);
